...
public class Formulario01 extends JFrame {
	...
	public Formulario01() {
		...
		JButton btnSabãoMais = new JButton("+");
		btnSabãoMais.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				contador4++;
				Acao a = new Acao();
				a.sabao(c);
		...
		btnSabãoMais.setBounds(519, 131, 41, 23);
		contentPane.add(btnSabãoMais);
		
		JButton btnSabãoMenos = new JButton("-");
		btnSabãoMenos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				contador4--;
				Acao a = new Acao();
				a.sabao(c);
		...
		btnSabãoMenos.setBounds(577, 131, 41, 23);
		contentPane.add(btnSabãoMenos);
